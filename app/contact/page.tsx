                ...
                <div className="container mx-auto max-w-7xl">
                    ...
                    <div className="mt-16 grid grid-cols-1 sm:grid-cols-3 gap-6">
                        <div className="flex items-center gap-4">
                            <div className="w-12 h-12 rounded-full bg-[#0C3318] flex items-center justify-center flex-shrink-0">
                                <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="white" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                                    <path d="M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07 19.5 19.5 0 0 1-6-6 19.79 19.79 0 0 1-3.07-8.67A2 2 0 0 1 4.11 2h3a2 2 0 0 1 2 1.72 12.84 12.84 0 0 0 .7 2.81 2 2 0 0 1-.45 2.11L8.09 9.91a16 16 0 0 0 6 6l1.27-1.27a2 2 0 0 1 2.11-.45 12.84 12.84 0 0 0 2.81.7A2 2 0 0 1 22 16.92z" />
                                </svg>
                            </div>
                            <span className="text-[#162018] font-semibold text-[15px] font-outfit">0092346616008</span>
                        </div>
                        ...
                        <div className="flex items-center gap-4">
                            ...
                            <a href="mailto:info@mebilling.com" className="text-[#162018] font-semibold text-[15px] font-outfit hover:text-[#1A6B3A] transition-colors">
                                Info@mebilling.com
                            </a>
                        </div>
